...
Strong hands-on experience with systems, software behavior, and problem analysis. Currently transitioning into professional QA roles.
...
Project 01: Basic Checkout Flow - Flujo completo de compra en SauceDemo.

Project 02: Advanced Cart Logic - Gestión dinámica de inventario y validación de badges.

Evidence: SEL-PROJ-01-basic-checkout.mp4 · SEL-PROJ-02-advanced-cart-logic.mp4.

Comando de ejecución: PYTHONPATH=. pytest automation_selenium/ -v
...
Evidence: evidence/API-POST-01.png, evidence/API-BUG-01.png.
...
Evidence: evidence/SQL-PROJECT-01.png, evidence/SQL-BUG-REPORT.png.
...
automation_selenium/ → Framework de automatización (POM) con Python.
...
sdlc-stlc/ → SDLC & STLC notes (Core Foundations)
